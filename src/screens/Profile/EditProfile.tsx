  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={{marginTop: 32, width: '100%', gap: 8, alignItems: 'center'}}>
        <View style={{padding: 12, borderRadius: 999, backgroundColor: Colors.backgroundColorsSecondary}}>
          <Image source={require('../../assets/images/avatar.jpg')} style={{width: 160, height: 160, borderRadius: 999}} />
